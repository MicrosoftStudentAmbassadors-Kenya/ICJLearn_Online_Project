  ...
  render() {
    ...
    return (
              ...
              <div className="col-md-6">
                <div className="card-body">
                  <div className="logoHead">
                    ...
                    />
                    <h3 className="mb-2">Imagine Cup Junior Learning</h3>
                  </div>
      ...
      //               </button> */}
                    ...
                    <button className="ht-btn ht-btn--round shadow-2 mb-4">
                      Login
                    </button>
                  </form>
                  ...
                  <p className="mb-0 text-muted">
                    <a
                      href={`${process.env.PUBLIC_URL}/forgot/`+this.props.match.params.role}
                      className="f-w-400"
                    >
                      Forgot Password?
                    </a>
